<div class="text-center">
    <h1 class="text-6xl font-title mb-10">Recursos</h1>
    <ul class="flex gap-5 flex-col text-center">
        ...
        <li class=""><b>Website:</b> <a href="/descobrir/blog" class="text-t">Blog</a> e outros...</li>
